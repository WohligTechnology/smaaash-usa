...
angular.module('phonecatControllers', ['templateservicemod', 'navigationservice', 'ui.bootstrap', 'ngAnimate', 'ngSanitize', 'angular-flexslider', 'ngDialog', 'imageupload', 'infinite-scroll'])
    ...
    .controller('DealspCtrl', function ($scope, $uibModal, TemplateService, NavigationService, $timeout, $filter, $stateParams) {
        //Used to name the .html file
        ...
        NavigationService.getSingleExploreSmaaashByUrl($stateParams.id, function (data) {
            ...
            $scope.SingleDealsPackages2 = $filter('orderBy')($scope.SingleDealsPackages, 'order');
            $scope.SingleDealsPackages = _.chunk($scope.SingleDealsPackages2, 3);
            TemplateService.removeLoader();
        });
            ...
            NavigationService.getGallery($scope.objectfilter, function (data) {
                ...
                if (data.value) {
                    ...
                    if (data.data.totalpages >= $scope.objectfilter.pagenumber) {
                        ...
                        $scope.chunkStars = _.chunk($scope.stars, 3)
                        if (data.data.data.length !== 0) {
    ...
    .controller('HostCtrl', function ($scope, TemplateService, NavigationService, $timeout, $filter, $stateParams, $uibModal, $location, $sce) {
